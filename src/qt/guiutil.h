...
/** Utility functions used by the Bouygues Qt UI.
 */
namespace GUIUtil
{
...
// Render Bouygues addresses in monospace font
...
// Parse "byg:" URI into recipient object, return true on successful parsing
