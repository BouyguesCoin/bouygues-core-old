...
RESOURCES += src/qt/byg.qrc src/qt/byg_locale.qrc

TRANSLATIONS += src/qt/locale/byg_bg.ts \
                src/qt/locale/byg_de.ts \
                src/qt/locale/byg_en.ts \
                src/qt/locale/byg_es.ts \
                src/qt/locale/byg_fi.ts \
                src/qt/locale/byg_fr.ts \
                src/qt/locale/byg_it.ts \
                src/qt/locale/byg_ja.ts \
                src/qt/locale/byg_pl.ts \
                src/qt/locale/byg_pt.ts \
                src/qt/locale/byg_ru.ts \
                src/qt/locale/byg_sk.ts \
                src/qt/locale/byg_sv.ts \
                src/qt/locale/byg_vi.ts \
                src/qt/locale/byg_zh_CN.ts \
                src/qt/locale/byg_zh_TW.ts
