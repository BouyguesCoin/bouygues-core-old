Contributing to Bouygues Core
============================

The Bouygues Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bouygues Core project, and is not to be
confused with overall Bouygues Network Protocol consensus changes.

Whether a pull request is merged into Bouygues Core rests with the project merge
...
Patches that change Bouygues consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bouygues consensus, it must have been
...
The project leader is the release manager for each Bouygues Core release.
