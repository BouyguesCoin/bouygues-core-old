...
This mechanism has been integrated into Bitcore-Node-Bouygues which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Bouygues-Project/insight-api-byg#web-socket-api](https://github.com/Bouygues-Project/insight-api-byg#web-socket-api) 
* API: [https://github.com/Bouygues-Project/insight-api-byg#instantsend-transactions](https://github.com/Bouygues-Project/insight-api-byg#instantsend-transactions) 
...
By default, the Bouygues Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bouygues Core daemon:
