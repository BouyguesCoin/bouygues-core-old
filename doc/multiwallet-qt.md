...
In order to support loading of multiple wallets in byg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is byg.cpp.
...
Changes to byg.cpp
----------------------
byg.cpp is the entry point into byg-qt, and as such, will require some minor modifications to provide hooks for
